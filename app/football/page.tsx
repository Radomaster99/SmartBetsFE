...
function parseUpcomingScope(value: string | null): 'today' | 'all' {
...
function buildFootballCanonicalPath(searchParams: URLSearchParams): string {
...
export async function generateMetadata({ searchParams }: FootballPageProps): Promise<Metadata> {
